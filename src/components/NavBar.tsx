        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          ...
          {showDropdown && (
            <div style={{ position: 'absolute', top: '40px', left: 0, backgroundColor: '#222', padding: '12px 16px', borderRadius: '6px', display: 'flex', flexDirection: 'column', zIndex: 1000, minWidth: '200px' }}>
              <a href="https://x.com/zukielementals" target="_blank" style={{ color: 'white', textDecoration: 'none', padding: '12px 0', fontSize: '22px', fontFamily: 'Arial, sans-serif', fontWeight: 'bold' }}>Zuki Elementals</a>
              <a href="https://x.com/ordinalpotions" target="_blank" style={{ color: 'white', textDecoration: 'none', padding: '12px 0', fontSize: '22px', fontFamily: 'Arial, sans-serif', fontWeight: 'bold' }}>Ordinal Potions</a>
            </div>
          )}
        </div>
      </div>
